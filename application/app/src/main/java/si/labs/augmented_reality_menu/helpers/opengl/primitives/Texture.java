 ...
 */
package si.labs.augmented_reality_menu.helpers.opengl.primitives;
...
public class Texture implements Closeable {
   ...
   * mostly only useful for creating {@link Target} textures. See {@link
   * #createFromAsset} if you want a texture with data.
   */
  public Texture(GeneralRenderer render, Target target, WrapMode wrapMode) {
    this.target = target;
  ...
  public static Texture createFromAsset(
          GeneralRenderer render, String assetFileName, WrapMode wrapMode) throws IOException {
